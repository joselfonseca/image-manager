<div class='row' id="images-container">
    ...
    <div class='col-lg-4' id="imageManager_{{$f->id}}">
        <div class="thumbnail">
            ...
            <div class="caption">
                <button class="btn btn-default" data-file-id='{{$f->id}}' data-preview-url="{{route('showthumb', $f->id)}}" data-action="selected-file"><i class="fa fa-check-circle"></i> Use</button>
